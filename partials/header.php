    ...
    <div class="navbar-nav flex-row d-lg-none">
      ...
      <div class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
          <a href="../all/config.php" class="dropdown-item">Configurações</a>
          <a href="../../auth/logout.php" class="dropdown-item">Logout</a>
          <a href="?theme=dark" class="dropdown-item hide-theme-dark" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Enable dark mode" data-bs-original-title="Enable dark mode">
            Tema Escuro
          </a>
          <a href="?theme=light" class="dropdown-item hide-theme-light" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Enable light mode" data-bs-original-title="Enable light mode">
            Tema Claro
          </a>
        </div>
      </div>
        ...
        <li class="nav-item">
          <a class="nav-link" href="./realtime.php">
            ...
            <span class="nav-link-title">
              Home 
              <!-- <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-star-filled ms-2 text-yellow" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8.243 7.34l-6.38 .925l-.113 .023a1 1 0 0 0 -.44 1.684l4.622 4.499l-1.09 6.355l-.013 .11a1 1 0 0 0 1.464 .944l5.706 -3l5.693 3l.1 .046a1 1 0 0 0 1.352 -1.1l-1.091 -6.355l4.624 -4.5l.078 -.085a1 1 0 0 0 -.633 -1.62l-6.38 -.926l-2.852 -5.78a1 1 0 0 0 -1.794 0l-2.853 5.78z" stroke-width="0" fill="currentColor" /></svg> -->
              <span>BLACK</span>
              <!-- <span class="badge badge-outline text-yellow">BLACK FRIDAY</span> -->
            </span>
          ...
          <div class="dropdown-menu">
            <div class="dropdown-menu-columns">
              ...
              <div class="dropdown-menu-column">
                <a class="dropdown-item" href="./waiterMenu.php">
                  Cardápio
                </a>
                <a class="dropdown-item" href="./allTablesSessions.php">
